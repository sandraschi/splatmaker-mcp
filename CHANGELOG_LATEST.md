...
## 0.1.0 — 2026-07-13 (unreleased scaffold)
...
**Not yet done:** splat-generation engine unwired (Postshot/gsplat/Nerfstudio not chosen); no persistence (jobs are in-memory); webapp is a skeleton only; no MCPB bundle built yet.
